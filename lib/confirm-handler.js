  ...
  sendPage(
    ...
    g
      ? `You're entered to win ${esc(g.title || 'the book')}, and I'll announce the winner on ${esc(g.announce || 'the announce date')}. Your daily Booky reminder starts tomorrow.`
        ...
        // carries them. Nobody is excluded, the prize just takes a different
        // form outside the US, which is the one thing the short card cannot say.
        + `<br><br><span style="font-size:13px;color:#8a6a8c;">Open worldwide. If you're in the US you'll get the hardcover. Anywhere else, a gift card for the same value.</span>`
