...
module.exports = async (req, res) => {
  ...
  sendPage(
    res, 200,
    'You\'re in 🎉',
    // The prize terms live in the confirmation email, above its button, which
    // is where the decision to enter is actually made. Repeating them here
    // would only tell someone the terms after they had already committed.
    g
