...
function listEmail({ ga, winnerName, entries, amzTag }) {
  ...
  return {
    ...
    html: shell({
      ...
      cta: null,
      secondary: { label: `Play today's Booky →`, url: PLAY_URL },
      cover: ga.cover,
      ...
      <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="max-width:480px;background:#ffffff;border:1px solid #ead4e2;border-radius:14px;padding:32px 28px;">
        <tr><td>
          ...
          <p style="margin:0;font-size:11px;color:#a587a9;line-height:1.6;">
            ${disclosure ? "If you grab it through the link up there, Amazon kicks a few cents back to me at no extra cost to you, and that's genuinely the entire budget behind these giveaways 😅 No pressure either way!!<br><br>" : ''}
