...
function listEmail({ ga, winnerName, entries, amzTag }) {
  ...
  const body = [
    ...
    `And thank you to everyone who entered. This is the first giveaway I've ever run in Booky and honestly I was surprised to see all the people who showed up 🙏`,
  ...
  return {
    ...
    html: shell({
      ...
      //
      // The tease is literally true on send day: the word for 2026-08-04 is
      // FANGS and words.json maps it to this same book. Re-check that mapping
      // before reusing this line for another giveaway.
      cta: null,
      secondary: { label: `Oh and today's word comes from this exact book 👀 go play it →`, url: PLAY_URL },
      cover: ga.cover,
